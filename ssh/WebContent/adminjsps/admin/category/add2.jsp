...
<style type="text/css">
  ...
  <body>
    ...
    <form action="${pageContext.request.contextPath}/addChild.do" method="post" onsubmit="return checkForm()">
...
<c:forEach items="${parents }" var="parent">
    		<option value="${parent.categoryId }" <c:if test="${parent.categoryId eq TCategory }">selected="selected"</c:if> >${parent.categoryName }</option>
</c:forEach>
    	</select><br/>
