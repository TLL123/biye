...
$(function() {
	...
	3. /goods/jsps/boo`	k/list.jsp：点击二级分类后链接到的URL
	4. body:链接的内容在哪个框架页中显示
	*/
	<c:forEach items="${parents}" var="parent">
	<c:forEach items="${parent.TCategories}" var="child">
		bar.add("${parent.categoryName}", "${child.categoryName}", "${pageContext.request.contextPath}/findByCategory.do?categoryId=${child.categoryId}", "body");
	</c:forEach>
	</c:forEach>
