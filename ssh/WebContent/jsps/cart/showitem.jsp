...
<body>
	<c:choose>
		...
		<c:otherwise>
			<form id="form1"
				action="${pageContext.request.contextPath}/Order/createOrder.do"
				method="post">
				...
				<table width="95%" align="center" cellpadding="0" cellspacing="0">
						...
						<tr align="center">
							<td align="right"><a class="linkImage"
								href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0"
									width="54" align="top"
									src="<c:url value='/${cartItem.TBook.bookImageB }'/>" /></a></td>
							<td align="left"><a
								href="<c:url value='/jsps/book/desc.jsp'/>"><span>${cartItem.TBook.bookName }</span></a>
							</td>
							<td>&yen;${cartItem.TBook.bookCurrPrice }</td>
							<td>${cartItem.cartitemCount }</td>
					...
					<tr>
						<td colspan="6" align="right"><span>总计：</span><span
							class="price_t">&yen;<span id="total" name="total">${total }</span></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="6"><input id="addr" type="text" name="address"
							value="四川省 成都市 郫县 中信大道二段1号  张三" /></td>
					</tr>
					<tr>
