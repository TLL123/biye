...
<div class="div2">
	...
	<dl>
		...
		<dd>${order.orderId }</dd>
		<dt>合计金额</dt>
		<dd><span class="price_t">&yen;${order.orderTotal }</span></dd>
		<dt>收货地址</dt>
		<dd>${order.orderAddress }</dd>
	</dl>
	<span>Books书城感谢您的支持，祝您购物愉快！</span>
	<a href="${pageContext.request.contextPath}/Order/paymentPre.do?orderId=${order.orderId }" id="linkPay">支付</a>
</div>
  </body>
</html>
